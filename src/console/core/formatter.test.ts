...
describe("formatter", () => {
  ...
  it("splits ip address by mask", () => {
    ...
    expect(formatter.splitByMasks(ip, 2, 3)).toEqual({
      vpc: "11",
      subnet: "0",
      hosts: "00000.10101000.00000001.00000001",
    });
    expect(formatter.splitByMasks(ip, 8, 16)).toEqual({
      vpc: "11000000",
      subnet: ".10101000",
      hosts: ".00000001.00000001",
    });
    expect(formatter.splitByMasks(ip, 8, 22)).toEqual({
      vpc: "11000000",
      subnet: ".10101000.000000",
      hosts: "01.00000001",
    });
  });
});
