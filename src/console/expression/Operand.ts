import type { ExpressionElement as ExpressionElement } from "./expression-interfaces";
import type { NumberBase } from "../core/formatter";
import { INT64_MAX_VALUE, INT64_MIN_VALUE, UINT64_MAX_VALUE } from "../core/const";
import { Integer, type JsNumber, isInteger, asInteger } from "../core/Integer";
...
export default class Operand implements ExpressionElement {
  ...
  constructor(value: Integer | JsNumber, base?: NumberBase) {
    if (!isInteger(value)) value = asInteger(value);
