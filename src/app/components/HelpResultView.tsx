...
function HelpResultView() {
  return (
    <div className="help helpResultTpl">
        ...
        <div className="left-panel">
          ...
          <div className="section">
            ...
            <ul>
              <li>
                <code>
                  <CommandLink text="light" />
                </code>{" "}
                — set the Light color theme
              </li>
              <li>
                <code>
                  <CommandLink text="dark" />
                </code>{" "}
                — set the Dark color theme
              </li>
              <li>
                <code>
                  <CommandLink text="midnight" />
                </code>{" "}
                — set the Midnight color theme
              </li>
            </ul>
          </div>
          <div className="section">
            ...
            <ul>
              <li>
                <code>
                  <CommandLink text="clear" />
                </code>{" "}
                — clear output pane
              </li>
              <li>
                <code>
                  <CommandLink text="help" />
                </code>{" "}
                — display this help
              </li>
              <li>
                <code>
                  <CommandLink text="whatsnew" />
                </code>{" "}
                — display changelog
              </li>
              <li>
              ...
              <li>
                <code>
                  <CommandLink text="about" />
                </code>{" "}
                — about the app
              </li>
              <li>
                <code>
                  <CommandLink text="guid" />
                </code>{" "}
                — generate <a href="https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_.28random.29">v4</a> GUID
              </li>
            </ul>
          </div>
        </div>
        <div className="right-panel">
          <div className="section">
            ...
            <ul>
              ...
              <li>
                <code>^</code> — bitwise exclusive XOR
              </li>
              <li>
              ...
              <li>
                <code>&gt;&gt;</code> — sign propagating right shift
              </li>
              <li>
            ...
            <div className="important-note">
              ...
              <a target="_blank" href="https://en.cppreference.com/w/c/language/operator_precedence">
                Operator precedence
              </a>{" "}
              is IGNORED. Operators are executed <strong>left-to-right</strong>.
            </div>
          </div>
          <div className="section soft-border">
            <div className="section-title soft">
              Supported Number Types <sup className="accent1">NEW</sup>
            </div>
            <p>
            ...
            <ul>
              <li>
                <code>8-bit integer</code> - a.k.a Byte. Numbers entered with <code>b</code> or <code>ub</code> suffixes for signed and unsigned versions respectively (e.g. <CommandLink text="10b 10ub" />
                ).
              </li>
              <li>
                <code>16-bit integer</code> - a.k.a Short. Numbers entered with <code>s</code> or <code>us</code> suffixes for signed and unsigned versions respectively (e.g. <CommandLink text="10s 10us" />
                ).
              </li>
              <li>
                <code>32-bit integer</code> - numbers entered without suffixes that fall in range of {INT32_MIN_VALUE} and {INT32_MAX_VALUE}. Use <code>u</code> suffix to denote an unsigned version of 32-bit integer. This is a default number type.
              </li>
              <li>
                <code>64-bit integer</code> - a.k.a Long. Numbers entered without suffixes and exceed the 32-bit range or entered with <code>l</code> and <code>ul</code> suffixes for signed and unsigned versions respectively (e.g. <CommandLink text="10l 10ul" />
                ).
              </li>
            </ul>
          </div>
