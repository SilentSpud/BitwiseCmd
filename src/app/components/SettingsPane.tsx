    ...
    <div id="settings" className="settings-container">
      <div className="inner solid-border">
        ...
        <div className="setting">
          ...
          <p className="description">{appState.emphasizeBytes ? "Binary strings are padded with extra bits to have a length that is multiple of 8." : "Binary strings are not padded with extra bits."}</p>
        </div>
        <div className="setting">
          ...
          <p className="description">{appState.dimExtraBits ? "Extra bits used for padding are now dimmed." : "No bits are dimmed."}</p>
        </div>
        <div className="setting">
          ...
          <p className="description">{appState.annotateTypes ? "Integers are displayed as they are stored in memory. Bit size is shown." : "Information about the size of integers is hidden."}</p>
        </div>
      </div>
    </div>
  );
